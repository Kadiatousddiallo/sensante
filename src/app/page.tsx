...
<StatCard titre="Alertes IA" valeur={8}
unite="urgentes"
...
<div className="grid grid-cols -1 md:grid-cols -3
gap -4 mb-8">
<PatientCard nom="Aminata Sow"
region="Dakar" age={34} sexe="F" />
<PatientCard nom="Ibrahima Ba"
region="Thiès" age={45} sexe="M" />
<PatientCard nom="Awa Diallo"
region="Saint -Louis" age={28} sexe="F" />
</div>
<h2 className="text-xl font-semibold
text-gray -700 mb-4">
Dernière consultation
</h2>
<ConsultationCard patient="Aminata Sow"
date="18 mars 2025"
